...
import psycopg2
import pickle
def ml(data,db_name,table_name,column_names=['m1','m2'],predict_names=['correctoutput','predictedoutput'],pas=''):
	...
	#IO.jsonfile(filename,db_name,table_name,predict_names,column_names,pas)
